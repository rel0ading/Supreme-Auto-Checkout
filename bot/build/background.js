    ...
    return _regenerator2.default.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            watcher = new _ProductWatcher2.default();
            _context7.next = 3;
...
var _StorageManager = __webpack_require__(75);
...
var _ProductWatcher = __webpack_require__(82);

var _ProductWatcher2 = _interopRequireDefault(_ProductWatcher);
...
}, { urls: ['*://*.supremenewyork.com/mobile/*', 'http://www.supremenewyork.com/mobile_stock.json'] }, ['blocking', 'requestHeaders']);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36), __webpack_require__(74)))
...
var _browserRequest = __webpack_require__(88);

var _browserRequest2 = _interopRequireDefault(_browserRequest);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ProductWatcher = function () {
  function ProductWatcher() {
    (0, _classCallCheck3.default)(this, ProductWatcher);

    this.products = {};
    this.lastUpdate = new Date();
  }

  (0, _createClass3.default)(ProductWatcher, [{
    key: 'start',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
        var products;
    ...
    value: function fetchProducts() {
      return new _promise2.default(function (resolve, reject) {
        (0, _browserRequest2.default)({ url: 'http://www.supremenewyork.com/mobile_stock.json' }, function (error, response, body) {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                now = new Date();
                diff = (now.getTime() - this.lastUpdate.getTime()) / 1000;

                if (!(diff >= 10 || !(0, _keys2.default)(this.products).length || force)) {
                  _context2.next = 13;
                  break;
                }
              ...
              case 13:
                return _context2.abrupt('return', this.products);
...
exports.default = ProductWatcher;
